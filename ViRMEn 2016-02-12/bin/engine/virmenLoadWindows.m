...
for ndx = length(exper.windows):-1:1
    ...
    if exper.windows{ndx}.fullScreen
        ...
        w(1:4,ndx) = [exper.windows{ndx}.left+mnt(1,indx)...
            mnt(4,indx)-(exper.windows{ndx}.bottom+mnt(2,indx))-exper.windows{ndx}.height ...
            exper.windows{ndx}.width...
            exper.windows{ndx}.height]';
    end
